...
function site5framework_header_init() {
	...
	wp_enqueue_script('qtip-js', get_template_directory_uri().'/lib/qtip/jquery.qtip.min.js',array('jquery'), '1.0', true);
	wp_enqueue_style('qtip-css', get_template_directory_uri().'/lib/qtip/jquery.qtip.min.css');
	...
	//wp_enqueue_style ('buddypress-custom-css', get_template_directory_uri().'/css/buddypress-styles.css');

	}
}
add_action('init', 'site5framework_header_init', 10);
